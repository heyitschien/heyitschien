# AI-Orchestrated Systems Engineering

## What this means

I use AI as a coordinated engineering system rather than a single chatbot. My role is to frame the problem, compare research and model perspectives, reduce ambiguity, make product and architecture decisions, translate those decisions into tracked work, route implementation to coding agents, and review the result against evidence and canonical documentation.
...
- preserve decisions in version-controlled documentation;
- translate decisions into scoped work;
- review generated implementation rather than trusting it automatically;
- use evidence to revise architecture when necessary;
- maintain a clear source of truth across tools.

## Tool and model roles

The exact mix changes by project, but the operating pattern is consistent:

- **ChatGPT:** research synthesis, systems reasoning, architecture translation, design critique, documentation review, and decision clarification.
- **Gemini:** independent cross-validation, alternate approaches, source exploration, and a second reasoning perspective.
- **Cursor and coding agents:** implementation, refactoring, repository changes, tests, and repetitive engineering execution.
- **GitHub:** versioned engineering memory, provenance, pull requests, review history, CI, and governance.
...
- AI operations and workflow support;
- customer operations;
- content systems;
- product operations;
- solutions and systems analysis;
- technical program coordination.

The common thread is turning unclear needs into structured, reviewable, testable work while keeping users and collaborators informed.
