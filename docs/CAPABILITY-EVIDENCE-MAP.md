...
| Documentation systems | Maintains durable context, decision history, setup guidance, and handoffs | [Chapter Reader](https://github.com/heyitschien/chapter-reader) · [Product Support Triage Sample](https://github.com/heyitschien/product-support-triage-sample) | Support, onboarding, implementation, operations |
